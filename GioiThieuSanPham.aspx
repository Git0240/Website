<%@ Page EnableEventValidation="false" Title="" Language="C#" MasterPageFile="~/mainchinh.master" AutoEventWireup="true" CodeFile="GioiThieuSanPham.aspx.cs" Inherits="GioiThieuSanPham" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div><asp:DataList ID="dtlSanPham" runat="server" RepeatColumns="3" Width="730px" CaptionAlign="Top" HorizontalAlign="Center">
        <ItemTemplate>
